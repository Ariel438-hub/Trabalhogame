...
kunai = pygame.image.load("base trabalho game/assets/kunai.png")
shuriken = pygame.image.load("base trabalho game/assets/shuriken.png")
objeto = pygame.image.load("base trabalho game/assets/icone.png")
